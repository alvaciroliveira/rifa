...
<body>
  <div class="container">
    ...
    <div class="form-group">
      ...
      <!--<select id="number" name="number"> #Esse campo pode ser desmarcado caso queira uma lista já com os números impressos
        <option value="">Selecione um número</option> -->
        <!-- Preencha a lista de números de 1 a 1000 -->
        <!-- Você também pode gerar essa lista dinamicamente usando JavaScript -->
        <!-- Exemplo de geração dinâmica de números: 
